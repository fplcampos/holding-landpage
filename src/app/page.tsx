...
import { LogoFSBHolding } from '@/utils/logos';
      ...
      <div data-cursor-color="#082057" data-cursor-size="20px">
        ...
        <section>
          <div className='container px-4 pt-40 pl-8 lg:pt-48 2xl:pt-64'>
            ...
            >
              <p className='max-w-[215px] lg:max-w-sm'>O maior e mais completo ecossistema de gestão de reputação da América Latina.</p>
            </motion.div>
            <motion.div
        ...
        <section className='min-h-fit'>
          <div className='relative z-40 lg:overflow-hidden' id='nos'>
            ...
            >
              <LogoFSBHolding className="relative z-50 w-full h-auto fill-fsb" />
            </motion.div>
          </div>
          <div className='relative z-30 flex justify-end'>
            ...
            >
              ...
              >
                <p>Por meio de agências, consultorias e soluções nos conectamos para melhor responder aos desafios de cada negócio e engajar todos os tipos de públicos.</p>
                <p className='mt-8'>Tudo isso com uma equipe multidisciplinar dedicada e mais de 40 anos de experiência em atender e entregar mais que nossos clientes esperam.</p>
                <div className='mt-8 text-2xl italic font-bold text-white font-tinos'>
                  <p>Somos a FSB holding. Reputação é resultado.</p>
                  <p>E vice-versa.</p>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section className='relative z-0 bg-bgparticles 2xl:pt-56' id='empresas' data-cursor-color="#082057" data-cursor-size="20px">
        <div className='container px-4 mb-8 lg:mb-0'>
          ...
          <motion.p className='text-2xl font-normal font-inter text-fsb xl:w-8/12 2xl:w-6/12'
            initial={{ y: 100, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1, transition: { ...animations.transition, delay: .23 } }}>Conheça as empresas que compõem o nosso ecossistema e que podem trabalhar de forma integrada pelo sucesso do seu negócio.</motion.p>
        </div>
      </section>
      <motion.div
        ...
        <section data-cursor-color="#ffffff" data-cursor-background-image="/images/ico-open.svg" data-cursor-size="70px">
          <motion.div className='rounded-[50px] bg-giusti mt-40 px-6 py-8 lg:pt-10 lg:pb-10 relative overflow-hidden'
            ...
            <div className='container text-white font-inter'>
              <Link href="https://linktr.ee/fsbholdingvagas" className='absolute top-0 left-0 w-full h-full' target='_blank'></Link>
              <p className='w-full text-2xl font-normal xl:w-5/12'>Confira todas as oportunidades na holding_</p>
              <div className='flex flex-col lg:flex-row'>
                <p className='italic leading-tight lg:leading-10 text-7xl font-inter lg:text-12xl lg:pb-6 md:pt-4'>vagas</p>
